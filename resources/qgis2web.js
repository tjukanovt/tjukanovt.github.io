...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [0.000000, -4786524.145421, 3634826.277280, 116635.930631], maxZoom: 8, minZoom: 3
    })
});

map.getView().fit([0.000000, -4786524.145421, 3634826.277280, 116635.930631], map.getSize());
